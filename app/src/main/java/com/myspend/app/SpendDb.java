...
public class SpendDb extends SQLiteOpenHelper {
 public SpendDb(Context c){super(c,"myspend.db",null,1);} public void onCreate(SQLiteDatabase d){d.execSQL("CREATE TABLE tx(id INTEGER PRIMARY KEY AUTOINCREMENT, ts INTEGER, amount REAL, kind TEXT, merchant TEXT, category TEXT, source TEXT, ref TEXT UNIQUE)");} public void onUpgrade(SQLiteDatabase d,int a,int b){}
